        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> BFP Account Settings /</span>Show Account
                    </h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input class="form-control" type="email" id="email" name="email" value="{{ ucfirst(str_replace('_', ' ', $accounts->role)) }}"
                                                readonly />
                                        </div>
                                    </div>
