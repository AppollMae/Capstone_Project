                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="container-xxl mt-4">
                                        ...
                                        <form method="POST" action="">
                                            ...
                                            <div class="border p-3 rounded mb-3">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <div>
                                                            <label><input type="checkbox" name="application_type[]"
                                                                    value="simple"> Simple</label><br>
                                                            <label><input type="checkbox" name="application_type[]"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div>
                                                            <label><input type="checkbox" name="for_type[]" value="new">
                                                                New</label><br>
                                                            <label><input type="checkbox" name="for_type[]" value="renewal">
                                                                Renewal</label><br>
                                                            <label><input type="checkbox" name="for_type[]"
                                                                    value="amendatory"> Amendatory</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6">
                                                        <label class="fw-bold">This applies also to:</label>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label><input type="checkbox" name="applies_to[]"
                                                                        value="locational_clearance"> Locational
                                                                    Clearance</label><br>
                                                                <label><input type="checkbox" name="applies_to[]"
                                                                        value="fire_safety"> Fire Safety</label>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label>Area No.: <input type="text"
                                            ...
                                            <!-- BOX 1 -->
                                            <div class="border p-3 rounded mb-3">
                                                <h5 class="fw-bold">BOX 1 — TO BE ACCOMPLISHED BY THE APPLICANT</h5>

                                                <!-- OWNER INFORMATION -->
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                        <label class="form-label">Owner / Applicant — Last Name</label>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-3">
                                                        <label class="form-label">For Construction Owned</label>
                                                        <select class="form-select" name="owned_by">
                                                            <option value="">Select...</option>
                                                            <option value="enterprise">By an Enterprise</option>
                                                            <option value="person">By a Person</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                        <label class="form-label">Location of Construction</label>
                                                        <input type="text" class="form-control" name="location_street">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="form-label">Barangay</label>
                                                        <input type="text" class="form-control" name="location_barangay">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="form-label">City/Municipality</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="form-label">Current Tax Dec. No.</label>
                                                        <input type="text" class="form-control" name="tax_dec_no">
                                                    </div>
                                                </div>

                                                <!-- CHARACTER OF CONSTRUCTION -->
                                                <label class="fw-bold">Character of Construction</label>
                                                <div class="row mb-3">
                                                    <div class="col-md-3">
                                                        <label><input type="checkbox" name="construction[]" value="new"> New
                                                            Construction</label><br>
                                                        <label><input type="checkbox" name="construction[]"
                                                                value="addition"> Addition</label><br>
                                                        <label><input type="checkbox" name="construction[]" value="repair">
                                                            Repair</label><br>
                                                        <label><input type="checkbox" name="construction[]"
                                                                value="conversion"> Conversion</label>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label><input type="checkbox" name="construction[]"
                                                                value="renovation"> Renovation</label><br>
                                                        <label><input type="checkbox" name="construction[]" value="moving">
                                                            Moving</label><br>
                                                        <label><input type="checkbox" name="construction[]" value="raising">
                                                            Raising</label><br>
                                                        <label><input type="checkbox" name="construction[]"
                                                                value="accessory"> Accessory Building</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label><input type="checkbox" name="construction[]"
                                                                value="legalization"> Legalization of Existing
                                                            Building</label><br>
                                                        <label>Others: <input type="text"
                                                                class="form-control form-control-sm mt-1"
                                                                name="construction_others"></label>
                                                    </div>
                                                </div>

                                                <!-- OCCUPANCY GROUP -->
                                                <label class="fw-bold">Use or Character of Occupancy</label>
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_a_residential"> Group A — Residential
                                                            Dwellings</label><br>
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_b_residential"> Group B — Residential (2 units
                                                            or more)</label><br>
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_c_education"> Group E — Educational</label><br>
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_f_business"> Group F — Business</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_g_storage"> Group G — Storage</label><br>
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_h_industrial"> Group H — Industrial</label><br>
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_i_assembly"> Group I — Assembly (e.g., hall,
                                                            court)</label><br>
                                                        <label><input type="checkbox" name="occupancy[]"
                                                                value="group_j_accessory"> Group J — Accessory
                                                            Structures</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Total Floor Area (sqm)</label>
                                                        <input type="number" class="form-control" name="floor_area">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="form-label">Lot Area (sqm)</label>
                                                        <input type="number" class="form-control" name="lot_area">
                                                    </div>
                                                    <div class="col-md-3">
                                            ...
                                            <!-- BOX 2 -->
                                            <div class="border p-3 rounded mb-3">
                                                <h5 class="fw-bold">BOX 2 — FULL-TIME INSPECTOR / ARCHITECT / ENGINEER</h5>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="inspector_address">
                                                    </div>
                                                </div>

                                                <h6 class="fw-bold">Architect or Civil Engineer</h6>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" name="prc_no">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="form-label">PTR No.</label>
                                                        <input type="text" class="form-control" name="ptr_no">
                                                    </div>
                                                    <div class="col-md-3">
                                            ...
                                            <!-- BOX 3 -->
                                            <div class="border p-3 rounded mb-3">
                                                <h5 class="fw-bold">BOX 3 — APPLICANT</h5>

                                                <div class="mb-3">
                                                    <label class="form-label">Signature over printed name</label>
                                                    <input type="text" class="form-control" name="applicant_signature">
                                                </div>

                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="form-label">Date</label>
                                                        <input type="date" class="form-control" name="applicant_date">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Gov't Issued ID No.</label>
                                                        <input type="text" class="form-control" name="applicant_id_no">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Place Issued</label>
                                                        <input type="text" class="form-control"
                                                            name="applicant_place_issued">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- BOX 4 -->
                                            <div class="border p-3 rounded mb-3">
                                                <h5 class="fw-bold">BOX 4 — LOT OWNER / REPRESENTATIVE CONSENT</h5>

                                                <div class="mb-3">
                                                    <label class="form-label">Signature over printed name</label>
                                                    <input type="text" class="form-control" name="lot_owner_signature">
                                                </div>

                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="form-label">Date</label>
                                                        <input type="date" class="form-control" name="lot_owner_date">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Gov't Issued ID No.</label>
                                                        <input type="text" class="form-control" name="lot_owner_id_no">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Place Issued</label>
                                                        <input type="text" class="form-control"
                                                            name="lot_owner_place_issued">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- BOX 5 -->
                                            <div class="border p-3 rounded mb-3">
                                                <h5 class="fw-bold">BOX 5 — NOTARIAL (TO BE ACCOMPLISHED BY NOTARY PUBLIC)
                                                </h5>

                                                <p>REPUBLIC OF THE PHILIPPINES )</p>
                                                <p>CITY/MUNICIPALITY OF __________________ ) S.S.</p>

                                                <p class="mt-3">BEFORE ME, personally appeared:</p>

                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                        <label class="form-label">Applicant Name</label>
                                                        <input type="text" class="form-control"
                                                            name="notary_applicant_name">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Gov't Issued ID No.</label>
                                                        <input type="text" class="form-control"
                                                            name="notary_applicant_id_no">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Date Issued</label>
                                                        <input type="date" class="form-control"
                                                            name="notary_applicant_date_issued">
                                                    </div>
                                                </div>

                                                <p>Witness my hand and seal this __________ day of __________.</p>

                                                <div class="mb-3">
                                                    <label class="form-label">Notary Public</label>
                                                    <input type="text" class="form-control" name="notary_public">
                                                </div>
                                            </div>

                                            <!-- SUBMIT -->
                                            <div class="mb-3">
                                                <a href="{{ route('applicants.permits.apply-permit') }}"
                                                    class="btn btn-secondary py-2">
                                                    ← Previous
                                                </a>

                                                <a href="{{ route('applicants.permits.unified-application-form-page-2') }}"
