              ...
              <div class="col-md-4 pt-3">
                <div class="card shadow border-0">
                  <div class="card-body text-center">
                    ...
                    <strong style="font-size: 3rem; color: #d62828;">{{ $totalApplicants }}</strong>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 pt-3">
                <div class="card shadow border-0 animate__animated animate__bounceIn">
                  <div class="card-body text-center">
                    ...
                    <h6 class="card-title fw-bold">PENDING APPLICATIONS OR PENDING PERMITS</h6>
                    <p class="text-muted mb-3">
                      Total pending building permits
                    </p>
                    <strong style="font-size: 3rem; color: #0077b6;">{{ $pendingPermits }}</strong>
                  </div>
                </div>
              </div>
              @endif
              ...
              <div class="col-md-4 pt-3">
                <div class="card shadow border-0">
                  <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-3">
                      Total under review building permits
                    </p>
                    <strong style="font-size: 3rem; color: #0077b6;">{{ $underReviewPermits }}</strong>
                  </div>
                </div>
              </div>
              @endif
              ...
              <div class="col-md-4 pt-3">
                <div class="card shadow border-0">
                  <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-3">
                      Total approved building permits
                    </p>
                    <strong style="font-size: 3rem; color: #0077b6;">{{ $approveApplications }}</strong>
                  </div>
                </div>
              </div>
              @endif
