    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveMenu === 'total_permits' ? 'active' : '' }}">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item {{ $SubActiveMenu === 'total_view' ? 'active' : '' }}">
                                                            ...
                                                            <div class="modal-dialog modal-md modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="{{ route('permits_applicants.permits.issued-flags') }}" method="POST">
                                                                            @csrf
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <table class="table table-bordered table-sm text-center align-middle">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        'Obstructed fire alarm panel',
                                                                                        'Improper storage of flammable materials',
                                                                                        'Emergency lights not working',
                                                                                        'Broken fire alarm system',
                                                                                        'No fire safety signage',
                                                                                        'Exit doors locked during operation',
                                                                                        'Damaged electrical outlets',
                                                                                        'Overloaded power sockets',
                                                                                        'Improper use of extension cords',
                                                                                        'Gas leaks or faulty gas lines',
                                                                                        'Cluttered evacuation routes',
                                                                                        'No fire drill conducted',
                                                                                        'Untrained staff on fire safety',
                                                                                        'Missing sprinkler system',
                                                                                        'Fire hose not functioning',
                                                                                        'Unauthorized structural modifications',
                                                                                        'Poor ventilation',
                                                                                        'Accumulated combustible waste',
                                                                                        'Improper placement of electrical appliances'
                                                                                        ];
