    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTabMenu === 'accounts' ? 'active' : '' }}">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ $SubActiveTabMenu === 'mpdo-update-accounts' ? 'active' : '' }}">
                            <a href="" class="menu-link">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                ...
                                <div class="avatar avatar-online">
                                    <img src="{{ $account->avatar ? asset('storage/' . $account->avatar) : asset('sneat/img/avatars/1.png') }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Profile Update Form -->
                                    <form action="{{ route('mpdo.accounts.mpdo-update-accounts') }}" method="POST"
