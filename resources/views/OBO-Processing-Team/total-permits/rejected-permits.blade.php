          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('obo.permit-applications.under-review') }}">
                ...
                <li class="nav-item">
                  <a class="nav-link {{ request()->routeIs('obo.permit-applications.rejected-permits') ? 'active' : '' }}" href="javascript:void(0);">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-striped text-center align-middle">
                      ...
                      <tbody>
                        @forelse($rejectedPermits as $permit)
                        <tr>
                       ...
                       color:#fff; font-weight:600; font-size:0.85rem; white-space:nowrap;">
                        ...
                        @empty
                        <tr>
                          <td colspan="8" class="text-muted text-center">No rejected permits
                            found.</td>
                        </tr>
                        @endforelse
                      </tbody>
