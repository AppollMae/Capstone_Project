    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTabMenu  === 'pending_tab' ? 'active' : ''}}">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">
                        ...
                        <a href="{{ route('permits_applicants.permits.total-permits') }}"
                            class="{{ request()->routeIs('permits_applicants.permits.total-permits') ? 'text-primary fw-bold' : 'text-dark' }}">
                            Total Permits
                        </a> /

                        <a href="{{ route('permits_applicants.permits.pending-permits') }}"
                            class="{{ request()->routeIs('permits_applicants.permits.pending-permits') ? 'text-primary fw-bold' : 'text-dark' }}">
                            Pending
                        </a> /

                        <a href="{{ route('permits_applicants.permits.under-review') }}"
                            class="{{ request()->routeIs('permits_applicants.permits.under-review') ? 'text-primary fw-bold' : 'text-dark' }}">
                            Under Review
                        </a> /
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('permits_applicants.permits.total-permits') }}">
