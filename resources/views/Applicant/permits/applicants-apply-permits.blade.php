                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="permitForm" action="{{ route('applicants.permits.store-permit') }}"
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <button type="submit"
                                                    formaction="{{ route('applicants.permits.draft-permit') }}"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <ul class="list-group mb-3">
                                                            <li class="list-group-item"><strong>Project Name:</strong> <span
                                                                    id="confirmProjectName">Sample Project</span></li>
                                                            <li class="list-group-item"><strong>Address:</strong> <span
                                                                    id="confirmAddress">123 Street</span></li>
                                                            <li class="list-group-item"><strong>Location:</strong> <span
                                                                    id="confirmLocation">City</span></li>
                                                            <li class="list-group-item"><strong>Project Cost:</strong> <span
                                                                    id="confirmProjectCost">50000</span></li>
                                                            <li class="list-group-item"><strong>Radius Range:</strong> <span
                                                                    id="confirmRadius">200</span> meters</li>
                                                            <li class="list-group-item"><strong>Description:</strong> <span
                                                                    id="confirmDescription">This is a test
                                                                    description.</span></li>
                                                        </ul>

                                                        <!-- 🗂️ Document preview in modal -->
                                                        <div class="mt-3">
                                                            <label class="form-label fw-bold">Uploaded Documents</label>
                                                        ...
                                                        <!-- 🗺️ Map preview -->
                                                        <div class="mt-3">
                                                            <label class="form-label fw-bold">Project Location
                                                                Preview</label>
                                                            <div id="confirmMap"
                                                                style="height: 300px; border: 1px solid #ccc; border-radius: 8px;">
                                                            </div>
                                                        </div>
                                                    </div>
